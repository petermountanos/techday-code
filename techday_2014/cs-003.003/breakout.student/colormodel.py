...
"""RGB class (colormodel) for the final project of CS.003, Breakout
...
# white in the default RGB space
WHITE = RGB(255, 255, 255)

# light gray in the default RGB space
LIGHT_GRAY = RGB(192, 192, 192)

# gray in the default RGB space
GRAY = RGB(128, 128, 128)

# dark gray in the default RGB space
DARK_GRAY = RGB(64, 64, 64)

# black in the default RGB space
BLACK = RGB(0, 0, 0)

# red, in the default RGB space
RED = RGB(255, 0, 0)

# pink in the default RGB space
PINK = RGB(255, 175, 175)

# orange in the default RGB space
ORANGE = RGB(255, 200, 0)

# yellow in the default RGB space
YELLOW = RGB(255, 255, 0)

# green in the default RGB space
GREEN = RGB(0, 255, 0);

# magenta in the default RGB space
MAGENTA = RGB(255, 0, 255)

# cyan in the default RGB space
CYAN = RGB(0, 255, 255)

# blue in the default RGB space
BLUE = RGB(0, 0, 255)