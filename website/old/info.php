          ...
          <ul class="nav navbar-nav navbar-right">
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                ...
                <li><a href="index.php">Home</a></li>
                <li><a href="http://bit.ly/wantaghtechday" target="_blank">Student Form</a></li>
        ...
        <div class="item active">
          ...
          <div class="container">
            <div class="carousel-caption">
              ...
              <p><a class="btn btn-lg btn-primary" href="http://bit.ly/wantaghtechday" role="button" target="_blank">Register today!</a></p>
            </div>
          </div>
        </div>
        <div class="item">
      ...
      <br>
        ...
        <section id="registration">
          ...
          <p align="justify">
            ...
            <strong>Friday, December 12th, 2014</strong>. Interested students and parents can fill out a <u><a href="http://bit.ly/wantaghtechday"
        ...
        <section id="contact">
          ...
          <address style="padding-top:5px;">
            <h4 style="float:right;">Wantagh TechDay  |  January 9th, 2016 | 
